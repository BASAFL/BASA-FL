...
workbook.save(r"C:\Users\user\Downloads\03\gao.xls") #这里save需要特别注意，文件格式只能是xls，不能是xlsx，不然会报错
print(len(nodeList))